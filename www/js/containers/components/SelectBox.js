        ...
        render() {
            ...
            var itemss = [];
                ...
                return ( < div className = "input-group form-group" style={{width:'100%'}}>
                    < label className = "input-group-addon" style={{width:'120px'}}> { header }{this.props.indeed && <span className="pull-left" style={{color:'red'}}>*</span>}:< /label> < select id={this.props.id} className = "form-control"
